...
categories: [Cyber-Apocalypse-CTF-2025]
...
[image](/images/eldoria-realm_01.png)
Sau đó export ra dạng raw để xử lý.
[image](/images/eldoria-realm_02.png)
...
[image](/images/eldoria-realm_03.png)


Gửi request tới endpoint `/connect-realm` để trigger tới lệnh curl
[image](/images/eldoria-realm_04.png)
[image](/images/eldoria-realm_05.png)

Decode để lấy flag:

```
echo "SFRCe2Y0azNfZmw0Z19mMHJfdDM1dDFuZ30=" | base64 -d
